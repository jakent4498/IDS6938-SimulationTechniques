...
int main()
{
	...
	std::ofstream myfile;
	myfile.open("results_mt19937_64-normalN100000.txt");
	for (auto p : hist) {
	...
	myfile.open("raw_results_mt19937_64-normalN100000.txt");
//	for (auto p : raw) {
	for (int i=0; i<N;i++) {
		double p = raw[i];
		double p2 = raw2[i];
	...
	myfile.open("useful_stats_mt19937_64-normalN100000.txt");
